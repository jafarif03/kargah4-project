				...
				<div class="col-12 col-md-12">
					...
					<div class="card mb-4 box-shadow">
						<div class="row">
							<div class="col-md-2 text-center">
								<span class="badge badge-Dark grey"><?php  echo $counter ?></span>
							...
							<div class="col-md-10 border-bottom">
								...
								<div class="row">
									...
									<div class="col-lg-1">
										<a href="?deleteId=<?php  echo $row['product_id'] ?>" style="color: ">
					...
					<div class="card mb-4 box-shadow">
						<div class="row">
							...
							<div class="col-md-2 text-center">
								<span class="badge badge-Dark grey mt-3 mb-3">تعداد: <?php echo $counter; ?></span>
							</div>

							<div class="col-md-4 text-center">
								<button class="btn btn-outline-warning mt-3 mb-3">نهایی سازی سبد خرید</button>
								<a href="?emptyCart" class="btn btn-outline-secondery mt-3 mb-3">خالی کردن سبد خرید</a>
							</div>
							<?php } ?>
						</div>
					</div>
